          ...
          () => Container(
            ...
            child: Stack(
              children: [
                ...
                Container(
                  margin: EdgeInsets.only(top: 100.w*3),
                  child: Column(
                    children: [
                      Expanded(
                      ...
                      BouncingWidget(
                        ...
                        child: Container(
                          height: 44.w*3,
                          width: 1.sw,
                          margin: EdgeInsets.fromLTRB(14.w*3, 0, 14.w*3, 20.w*3),
                          decoration: BoxDecoration(
            ...
            builderDelegate: PagedChildBuilderDelegate<dynamic>(
              itemBuilder: (context, item, index) => InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: logic.index.value == index
                        ? HhColors.backBlueInColor
                        : HhColors.whiteColor,
                    border: logic.index.value == index
                        ? Border.all(color: HhColors.backBlueOutColor)
                        : null,
                    borderRadius:
          ...
          InkWell(
            onTap: () {
              Get.to(
                ...
                arguments: logic.location.value.contains("点击选择")
                    ? null
                    : {
