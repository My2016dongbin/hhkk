...
class MainPage extends StatelessWidget {
      ...
      children: [
        ...
        Align(
          ...
          child: Row(
            ...
            children: [
              ///报警
              Permissions.hasPermission(Permissions.mainMessage)
                  ? BouncingWidget(
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Image.asset(
                                  logic.messageCount.value != "0"
                                      ? "assets/images/common/main_warning.gif"
                                      : "assets/images/common/main_warn.png",
                                  width: logic.messageCount.value != "0"
                                      ? 30.w * 3
                                      : 28.w * 3,
                                  height: logic.messageCount.value != "0"
                                      ? 30.w * 3
                                      : 32.w * 3,
                                  fit: BoxFit.fill,
                                ),
                            ...
                            logic.messageCount.value == "0"
                                ...
                                : Align(
                                    ...
                                    child: Container(
                                      ...
                                      width: 15.w * 3 +
                                          ((logic.messageCount.value.length -
                                                  1) *
                                              (3.w * 3)),
                                      height: 15.w * 3,
                                      child: Center(
                                          child: Text(
                                        logic.messageCount.value,
                                        style: TextStyle(
          ...
          child: EasyRefresh(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ///轮播图
                  Permissions.hasPermission(Permissions.mainBanner)
                      ? Stack(
                          alignment: Alignment.bottomCenter,
                          children: [
                            Container(
                              margin:
                                  EdgeInsets.fromLTRB(14.w * 3, 0, 14.w * 3, 0),
                  ...
                  ///设备统计
                  Permissions.hasPermission(Permissions.mainDeviceMonitor)
                      ? Container(
                          width: 1.sw,
                          height: 90.w * 3,
                          margin: EdgeInsets.fromLTRB(
                              14.w * 3, 10.w * 3, 14.w * 3, 0),
                          child: Row(
                            children: [
                              Expanded(
                                child: Container(
                              ...
                              InkWell(
                                onTap: () {
                                  Get.to(() => TodayWarningPage(),
                                      binding: TodayWarningBinding());
                                },
                                child: Container(
                                  height: 90.w * 3,
                                  width: 76.w * 3,
                  ...
                  ///菜单
                  Permissions.hasPermission(Permissions.mainMenu)
                      ? Container(
                          height: 100.w * 3,
                          width: 1.sw,
                          margin: EdgeInsets.fromLTRB(
                          ...
                          child: Column(
                            children: [
                                ...
                                child: ScrollConfiguration(
                                  ...
                                  child: PageView.builder(
                                      ...
                                      itemBuilder: (context, pageIndex) {
                                        int start =
                                            pageIndex * logic.menuCountInPage;
                                        int end =
                                        ...
                                        List<dynamic> pageItems =
                                            logic.menuList.sublist(start, end);
                                        ...
                                        return GridView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            return menuGridView(context,
                                                pageItems[index], index);
                                          },
                                        );
                                      }),
                                ),
                              ...
                              ///指示器
                              logic.menuPageCount.value > 1
                                  ? Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                                      children: List.generate(
                                          logic.menuPageCount.value, (index) {
                                        return Container(
                                          margin: EdgeInsets.symmetric(
                                              horizontal: 1.w * 3,
                                              vertical: 2.w * 3),
                                          width: logic.currentMenuPage.value ==
                                                  index
                                              ? 5.w * 3
                                              : 13.w * 3,
                                          height: 4.w * 3,
                                          decoration: BoxDecoration(
                                              shape: BoxShape.rectangle,
                                              color: logic.currentMenuPage
                                                          .value ==
                                                      index
                                                  ? HhColors.mainBlueColor
                                                  : HhColors.grayDDBackColor,
                                              borderRadius:
                                                  BorderRadius.circular(
                                                      2.w * 3)),
                                        );
                  ...
                  Permissions.hasPermission(Permissions.mainDeviceMonitor)
                      ? Container(
                          ...
                          child: logic.liveWarningList.isNotEmpty
                              ? ListView.builder(
                  ...
                  ///火险等级
                  Permissions.hasPermission(Permissions.mainFireLevel)
                      ? Container(
                          margin: EdgeInsets.fromLTRB(
                              14.w * 3, 14.w * 3, 14.w * 3, 0),
                          height: 30.w * 3,
                          width: 1.sw,
                          child: Stack(
                            children: [
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      CommonUtils().parseNull(
                                                          "${logic.fireLevelByStationList[0]}",
                                                          "0"),
                                                      style: TextStyle(
                                                          color: HhColors
                                                              .levelColor5,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      CommonUtils().parseNull(
                                                          "${logic.fireLevelByStationList[1]}",
                                                          "0"),
                                                      style: TextStyle(
                                                          color: HhColors
                                                              .levelColor4,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      CommonUtils().parseNull(
                                                          "${logic.fireLevelByStationList[2]}",
                                                          "0"),
                                                      style: TextStyle(
                                                          color: HhColors
                                                              .levelColor3,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      CommonUtils().parseNull(
                                                          "${logic.fireLevelByStationList[3]}",
                                                          "0"),
                                                      style: TextStyle(
                                                          color: HhColors
                                                              .levelColor2,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      CommonUtils().parseNull(
                                                          "${logic.fireLevelByStationList[4]}",
                                                          "0"),
                                                      style: TextStyle(
                                                          color: HhColors
                                                              .levelColor1,
                                  ...
                                  Expanded(
                                    child: logic.fireLevelList.isNotEmpty
                                        ? ListView.builder(
                                            padding: EdgeInsets.zero,
                                            scrollDirection: Axis.vertical,
                                            itemCount:
                                                logic.fireLevelList.length,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          child: Text(
                        logic.deviceStatus.value == 0 ? '离线状态' : '创建时间',
                        textAlign: TextAlign.start,
                        style: TextStyle(
                            color: HhColors.blackColor,
                            fontSize: 14.sp * 3,
        ...
        child: Row(
          children: [
            ...
            Expanded(
                child: Text(
              logic.deviceStatus.value == 0
                  ? parseOfflineDays('${item["alarmType"]}')
                  : CommonUtils().parseLongTime('${item["createTime"]}'),
              textAlign: TextAlign.start,
              maxLines: 1,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(
                  color: logic.deviceStatus.value == 0
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Image.asset(
                CommonUtils()
                    .parseDeviceImageWarn(logic.liveWarningList.value[index]),
                width: 40.w * 3,
                height: 40.w * 3,
                fit: BoxFit.fill,
              ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    CommonUtils().parseLongTime(
                        "${logic.liveWarningList.value[index]['alarmTimestamp']}"),
                    maxLines: 1,
                    style: TextStyle(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color:
                      "${logic.liveWarningList.value[index]['auditStatus']}" ==
                              "1"
                          ? HhColors.levelBtnBackGreen
                          : HhColors.levelBtnBack,
                  borderRadius: BorderRadius.circular(4.w * 3)),
              child: Text(
                "${logic.liveWarningList.value[index]['auditStatus']}" == "1"
                    ? "已处理"
                    : "未处理",
                style: TextStyle(
                    color:
      ...
      onTapUp: () {
        ...
        Get.to(
            () => HXYZDeviceDetailPage(
                  '${logic.fireLevelList.value[index]['deviceNo']}',
                  '${logic.fireLevelList.value[index]['id']}',
                  logic.fireLevelList.value[index]['shareMark'] ?? 2,
                ),
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                CommonUtils().parseNull(
                    "${logic.fireLevelList.value[index]['name']}", ""),
                maxLines: 1,
                style: TextStyle(
                    color: HhColors.blackTextColor,
                    overflow: TextOverflow.ellipsis,
  ...
  void menuTap(item) {
    ...
    if (item["title"] == "火险因子") {
      Get.to(() => DeviceListPage(), binding: DeviceListBinding(), arguments: {
        "productKey": CommonData.productKeyFireRiskFactor,
        "title": "火险因子"
      });
    }
    if (item["title"] == "报警管理") {
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                                child: Text(
                              parseAlarmType(fireInfo["alarmType"]),
                              textAlign: TextAlign.end,
                              style: TextStyle(
                                  color: HhColors.mainBlueColor,
                                  fontSize: 14.sp * 3),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            HhTap(
                              overlayColor: HhColors.trans,
                              onTapUp: () {
                                CommonUtils().showPictureDialog(Get.context,
                                    url:
                                    "${fireInfo['alarmImageUrl']}".startsWith("http")?"${fireInfo['alarmImageUrl']}":"${CommonData.endpoint}${fireInfo['alarmImageUrl']}");
                              },
                              child: Image.network(
                                "${fireInfo['alarmImageUrl']}".startsWith("http")?"${fireInfo['alarmImageUrl']}":"${CommonData.endpoint}${fireInfo['alarmImageUrl']}",
                                width: 1.sw,
