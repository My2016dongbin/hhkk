...
class VideoPage extends StatelessWidget {
  ...
  bool _hasVideoSource(int index) {
    return CommonData.checkedChannels[index]["url"] != null ||
        CommonData.checkedChannels[index]["hikSdkParams"] != null;
  }

  bool _isHikPlayer(int index) {
    return "${CommonData.checkedChannels[index]["platformType"]}" == "hikiot" &&
        CommonData.checkedChannels[index]["hikSdkParams"] != null;
  }
                          ...
                          BouncingWidget(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Image.asset(
                                    logic.pageListStatus.value
                                        ? "assets/images/common/video_list_select.png"
                                        : "assets/images/common/video_list_un.png",
                                    width: 22.w * 3,
                                    height: 22.w * 3,
                                    fit: BoxFit.fill,
                                  ),
                                  ...
                                  Text(
                                    '列表模式',
                                    style: TextStyle(
                                        color: logic.pageListStatus.value
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Image.asset(
                                    logic.pageListStatus.value
                                        ? "assets/images/common/video_card_un.png"
                                        : "assets/images/common/video_card_select.png",
                                    width: 22.w * 3,
                                    height: 22.w * 3,
                                    fit: BoxFit.fill,
                                  ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(
                                width: logic.text.value.contains('未获取')
                                    ? 2.w * 3
                                    : 6.w * 3,
                              ),
                              Text(
                                logic.text.value.contains('未获取')
                                    ? logic.text.value
                                    : "${logic.dateStr.value} ${logic.cityStr.value}",
                                style: TextStyle(
  ...
  ///主页-列表模式视图
  listPage(context) {
    return logic.videoIndex.value == 999
        ? const SizedBox()
        : Expanded(
            child: Column(
              children: [
                            ...
                            items: [
                              HhTap(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(
                                    logic.videoCount.value == 1
                                        ? "assets/images/common/icon_video_1_select.png"
                                        : "assets/images/common/icon_video_1.png",
                                    width: 24.w * 3,
                                    height: 24.w * 3,
                                  ),
                                ),
                              ...
                              HhTap(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(
                                    logic.videoCount.value == 4
                                        ? "assets/images/common/icon_video_4_select.png"
                                        : "assets/images/common/icon_video_4.png",
                                    width: 24.w * 3,
                                    height: 24.w * 3,
                                  ),
                                ),
                              ...
                              HhTap(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(
                                    logic.videoCount.value == 8
                                        ? "assets/images/common/icon_video_8_select.png"
                                        : "assets/images/common/icon_video_8.png",
                                    width: 24.w * 3,
                                    height: 24.w * 3,
                                  ),
                                ),
  ...
  ///主页-卡片模式视图
  cardPage(context) {
    return logic.containStatus.value
        ? Expanded(
            child: Column(
              children: [
                ///空间列表滚动
                SizedBox(
                  ...
                  child: Stack(
                    children: [
                      Align(
                        alignment: Alignment.centerLeft,
                        child: logic.spaceListStatus.value
                            ? Container(
                                margin: EdgeInsets.fromLTRB(
                                    10.w * 3, 0, 70.w * 3, 10.w),
                      ...
                      Align(
                        ...
                        child: BouncingWidget(
                          ...
                          child: Container(
                            margin:
                                EdgeInsets.fromLTRB(0, 0.w * 3, 14.w * 3, 0),
  ...
  gridItemView(BuildContext context, dynamic item, int index) {
    return Container(
      ...
      margin: EdgeInsets.fromLTRB(index % 2 == 0 ? 14.w * 3 : 11.w * 3,
          15.w * 3, index % 2 == 0 ? 0 : 14.w * 3, 0),
      decoration: BoxDecoration(
          color: HhColors.whiteColor,
        ...
        children: [
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.vertical(
                            top: Radius.circular(16.w * 3))),
                    child: item['status'] == 1
                        ? logic.parseCacheImageView('${item['deviceNo']}', item)
                        : Image.asset(
          ...
          InkWell(
            ...
            child: Container(
              height: 33.w * 3,
              padding:
                  EdgeInsets.fromLTRB(12.w * 3, 5.w * 3, 15.w * 3, 7.w * 3),
              color: HhColors.whiteColor,
              child: Row(
                ...
                children: [
                  ...
                  CommonData.personal
                      ? (item["shareMark"] == 1 || item["shareMark"] == 2
                          ? Container(
                              padding: EdgeInsets.fromLTRB(
                                  8.w * 3, 3.w * 3, 8.w * 3, 2.w * 3),
                              decoration: BoxDecoration(
                      ...
                      : const SizedBox(),
                  Container(
                      padding: EdgeInsets.only(left: 8.w * 3),
                      child: Text(
                        ':',
                        style: TextStyle(
                            color: HhColors.gray9TextColor,
          ...
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                    color: logic.spaceListIndex.value == i
                        ? HhColors.blackTextColor
                        : HhColors.gray9TextColor,
                    fontSize:
                        logic.spaceListIndex.value == i ? 18.sp * 3 : 16.sp * 3,
                    fontWeight: logic.spaceListIndex.value == i
                        ? FontWeight.bold
                        : FontWeight.w500),
              ),
              SizedBox(
                            ...
                            children: [
                              ...
                              Container(
                                margin: EdgeInsets.symmetric(
                                    horizontal: 15.w * 3, vertical: 10.w * 3),
                                padding:
                                    EdgeInsets.symmetric(horizontal: 5.w * 3),
                                decoration: BoxDecoration(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius:
                                          BorderRadius.circular(8.w * 3)),
                                  margin: EdgeInsets.fromLTRB(
                                      15.w * 3, 0, 15.w * 3, 10.w * 3),
                                  child: ListView.builder(
                                    padding: EdgeInsets.fromLTRB(
                                        10.w * 3, 0, 10.w * 3, 0),
                                    scrollDirection: Axis.vertical,
                                    itemCount: logic.treeDetail.length,
                                    itemBuilder: (context, index) {
                                      return TreeNodeWidget(
                                        ...
                                        onStarTap: (channel, star, deviceType,
                                          ...
                                          HhLog.d(
                                              "${channel["channelName"]} $star");
                                          final SharedPreferences prefs =
                                              await SharedPreferences
                                                  .getInstance();
                                          String userId =
                                              prefs.getString(SPKeys().id) ??
                                                  "";
                                          if (star) {
                                            logic.collection(
                                                userId,
...
class TreeNodeWidget extends StatefulWidget {
  ...
  final void Function(
      dynamic channel, bool star, String deviceType, dynamic device)? onStarTap;
...
class _TreeNodeWidgetState extends State<TreeNodeWidget> {
  ...
  void initState() {
    expanded = CommonUtils()
        .parseContainChannels(widget.node, CommonData.checkedChannels);
...
class _TreeDeviceWidgetState extends State<TreeDeviceWidget> {
  ...
  void initState() {
    expanded = CommonUtils()
        .parseContainChannels(widget.device, CommonData.checkedChannels);
    if (CommonData.videoSearch.isNotEmpty) {
                    ...
                    ? Column(
                        children: List.generate(channels.length, (i) {
                          return TreeChannelWidget(
                            key: Key(
                                "${channels[i]["id"]}${Random().nextInt(10000000)}"),
                            channel: channels[i],
                            onChannelTap: widget.onChannelTap,
                            level: widget.level + 1,
...
class _TreeChannelWidgetState extends State<TreeChannelWidget> {
  ...
  void initState() {
    checked = CommonUtils()
        .parseContainChannels(widget.channel, CommonData.checkedChannels);
        ...
        InkWell(
          ...
          onTap: () {
            ...
            if (widget.onChannelTap != null)
              widget.onChannelTap!(widget.channel, checked);
          },
          child: Container(
            height: 48.w * 3,
            padding: EdgeInsets.only(left: widget.level * 15.w * 3),
                ...
                InkWell(
                  onTap: () {
                    ...
                    if (widget.onStarTap != null)
                      widget.onStarTap!(widget.channel, star);
                  },
                  child: Container(
                    color: HhColors.trans,
                    ...
                    child: Image.asset(
                      star
                          ? 'assets/images/common/device_star.png'
                          : 'assets/images/common/device_un_star.png',
                      height: 17.w * 3,
                      width: 17.w * 3,
                      fit: BoxFit.contain,
                    ),
