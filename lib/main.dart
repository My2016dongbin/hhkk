...
Future<void> main() async {
  ...
  FlutterBugly.postCatchedException(() async {
    ...
    ///注册bugly
    FlutterBugly.init(androidAppId: "0e51144628", iOSAppId: "ed96239f50");
  });
...
class MyAppState extends State<HhApp> {
  ...
  void initState() {
    ...
    if (Platform.isIOS) {
      ...
      XgFlutterPlugin().startXg(
          CommonData.personal ? "1500040929" : "1500041692",
          CommonData.personal ? "A2UCA4MQX4ST" : "AAST7H0KI7QE");
    }
    ...
    XgFlutterPlugin().addEventHandler(
      xgPushClickAction: (Map<String, dynamic> msg) async {
        ...
        if (CommonData.personal &&
            custom != null &&
            custom['otherInfomation']['messageType'] == "deviceShare") {
        ...
        try {
          ...
          if (custom != null &&
            ...
            EventBusUtil.getInstance()
                .fire(Share(model: custom['otherInfomation']));
          }
          //其他设备登录
          if (custom != null &&
              custom['otherInfomation']['messageType'] == "logoutdelete") {
