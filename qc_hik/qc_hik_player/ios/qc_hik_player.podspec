...
Flutter plugin for HikIot live stream player on Android and iOS.
  ...
  s.source           = { :path => '.' }
  s.source_files     = 'Classes/**/*.{h,m,mm}', 'ThirdParty/HikiotOpenSDK/Core/Custom/**/*.{h,mm}'
  s.public_header_files = 'Classes/**/*.h'
  s.resources        = [
    'ThirdParty/HikiotOpenSDK/Core/lib/EzvizLib/doc/dependency_EZPlayerSDK.ini',
    'ThirdParty/HikiotOpenSDK/Core/lib/EzvizLib/doc/dependency_EZVideoTalk.ini',
    'ThirdParty/HikiotOpenSDK/Core/lib/EzvizLib/res/iOS/**/*'
  ]
