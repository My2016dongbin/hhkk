...
//////////////////////////////////////////////////////////////////////////
	...
	//MSVC Version (vs98/vs2003/vs2005/vs2008/vs2010/vs2012)
	...
	#else
        #ifdef __cplusplus
            #define HPR_DECLARE extern "C" __attribute__ ((visibility("default")))
        #else
            #define HPR_DECLARE
        #endif
	#endif

	#define HPR_DECLARE_CLASS __attribute__ ((visibility("default")))
	#define HPR_DECLARE_CXX __attribute__ ((visibility("default")))
