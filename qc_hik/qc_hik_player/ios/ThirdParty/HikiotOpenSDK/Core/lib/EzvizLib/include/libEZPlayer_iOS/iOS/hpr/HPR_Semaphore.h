...
/**
 ...
 @return 0成功 -1失败
 */
HPR_DECLARE HPR_INT32 CALLBACK HPR_Set_SemName(const char *semName);

/**
 清除之前创建的信号量，必须设置HPR_SetSemaphoreName()接口以后调用，建议在程序启动时调用一次
 
 @return 0成功 -1失败
 */
HPR_DECLARE HPR_INT32 CALLBACK HPR_ClearAllSema();
