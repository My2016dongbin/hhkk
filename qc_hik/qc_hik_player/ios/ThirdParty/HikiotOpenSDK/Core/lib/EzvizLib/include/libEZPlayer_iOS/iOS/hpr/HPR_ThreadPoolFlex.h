...
#else
HPR_DECLARE HPR_HANDLE CALLBACK HPR_ThreadPoolFlex_Create(HPR_UINT32 nMaxThreadNum, HPR_UINT32 nIldeTime, HPR_VOIDPTR(CALLBACK *fWorkRoutine)(HPR_VOIDPTR), HPR_UINT32 nStackSize);
#endif
/**
...
#else
HPR_DECLARE HPR_INT32 CALLBACK HPR_ThreadPoolFlex_DestroyEx(HPR_HANDLE hHandle,HPR_INT32 iWaitTime);
#endif
#endif
