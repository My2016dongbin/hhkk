...
//用于域名解析
HPR_DECLARE HPR_INT32 CALLBACK HPR_GetAddressInfo(const char *sNodeName, const char *sServerName,struct  HPR_ADDRESS_INFO *Hints,struct  HPR_ADDRESS_INFO **pRes);
HPR_DECLARE HPR_INT32 CALLBACK HPR_FreeAddressInfo(struct HPR_ADDRESS_INFO *pAddressInfo);
